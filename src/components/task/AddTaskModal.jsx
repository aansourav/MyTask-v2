      ...
      <form className=" absolute z-10 top-1/4 left-1/4 mx-auto my-10 w-full max-w-[540px] rounded-xl border border-[#FEFBFB]/[36%] bg-[#191D26] p-9 max-md:px-4 lg:my-20 lg:p-11">
        ...
        <div className="mt-16 flex justify-center lg:mt-20">
          <button
            ...
            type="submit"
            className="rounded mr-2 bg-blue-600 px-4 py-2 text-white transition-all hover:opacity-80"
          >
            {isAdd ? "Add Task" : "Save"}
          </button>
          <button
            className="ml-2 rounded bg-red-600 px-4 py-2 text-white transition-all hover:opacity-80"
